...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--planner", type=str, default="a_star", help="a_star/rrt/rrt_star")   # -p是--planner的簡寫，若要使用arg.p則需要加上dest="p"
    parser.add_argument("--smooth", action="store_true", help="true/false") # action="store_true"表示當該參數存在時，其值為True
    ...
    m = 1-cv2.dilate(1-m, np.ones((20,20)))   # 讓牆壁變厚一點，方便規劃路徑
